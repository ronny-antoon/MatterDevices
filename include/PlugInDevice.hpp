...
public:
     ...
     */
    PlugInDevice(char *device_name = nullptr, gpio_num_t relay_pin = GPIO_NUM_NC, gpio_num_t button_pin = GPIO_NUM_NC, esp_matter::endpoint_t *aggregator = nullptr);
...
private:
    ...
    PluginAccessory *accessory;       /**< Pointer to the PlugInAccessory instance. */
