...
class FanDevice : public BaseDevice {
 public:
   ...
   */
  FanDevice(const char *device_name = nullptr, FanAccessoryInterface *fanAccessory = nullptr,
 ...
 private:
  ...
  FanAccessoryInterface *fanAccessory; /**< Pointer to the FanAccessory instance. */
